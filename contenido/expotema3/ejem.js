    ...
    function canvasApp(){
        ...
        switch(fillOrStroke){
            ...
            case"both":
               context.fillStyle=tempColor;
               context.fillText(message,xPosition,yPosition);
               context.strokeStyle="#000000";context.strokeText(message,xPosition,yPosition);
               break;
           }
       }
       ...
       {
       	var target=e.target;message=target.value;
       	drawScreen();
       }
       ...
       function textAlignChanged(e){
       	var target=e.target;textAlign=target.value;
       	drawScreen();
       }
